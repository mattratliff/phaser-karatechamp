...
import sounds_mp3 from './newsounds.mp3';
import sounds_webm from './newsounds.webm';
const config = {
  ...
  sprite: {
    ...
    Level_Track: [25000, 149777.3469387755],
    Scree: [176000, 256.5079365079441],
    SmallJump: [178000, 277.2108843537353],
    SmallJump_1: [180000, 292.8571428571445],
    Step: [182000, 119.0476190476204],
    Stomp_Short: [184000, 2188.027210884343],
    Stomp_Short_1: [188000, 1578.6167800453654],
    Title_Track: [191000, 112324.01360544219],
    Main_Menu: [304000, 90600]
  }
};
